...
-   Windows 8、Windows 8.1、Windows 10 或更高版本的 64 位专业版。  
 ...
 ![确认系统要求](../cross-platform/media/android_emu_system_requirements.png "Android\_Emu\_System\_Requirements")  
...
>  加入该组后，注销或重启以使更改生效。  
 ...
 ![加入 Hyper&#45;V Administrators 安全组](../cross-platform/media/android_emu_hyperv_admin.png "Android\_Emu\_HyperV\_Admin")  
...
##  <a name="BootableVHD"></a> 不支持从可启动 VHD 运行仿真器  
 ...
 此配置不受支持。 有关相关问题的信息，请参阅 [适用于 Android 的 Visual Studio 仿真程序疑难解答](../cross-platform/troubleshooting-the-visual-studio-emulator-for-android.md)。  
