...
4.  按下 F5 启动调试，或按下 Shift+F5 来在不进行调试的情况下启动。  
     ...
     ![在 Android 仿真器中运行的应用](~/docs/cross-platform/media/cppmdd_opengles_andemulator.png "CPPMDD_OpenGLES_AndEmulator")  
...
4.  选择工具栏上的“iOS 模拟器”  以在 Mac 上运行 iOS 模拟器中的应用。 启动模拟器可能会花费稍许时间。 你可能须将模拟器放在 Mac 上的前台中以查看其输出。  
     ...
     ![iOS 应用中断点处的调试器](~/docs/cross-platform/media/cppmdd_opengles_iosdebug.png "CPPMDD_OpenGLES_iOSDebug")  
