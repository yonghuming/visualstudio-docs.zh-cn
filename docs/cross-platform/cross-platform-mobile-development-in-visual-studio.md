...
##  <a name="NET"></a>构建面向 Android、iOS 和 Windows 的应用 (.NET Framework)
 ![设备](~/docs/cross-platform/media/homedevices.png "家庭设备")
...
####  <a name="ShareHTML"></a> 在 Android、iOS 和 Windows 应用间共享代码
 ...
 ![在 Windows、iOS 和 Android UI 之间共享代码](~/docs/cross-platform/media/sharecode.png "共享代码")
...
###  <a name="WindowsHTML"></a>面向 Windows 10 设备
 ![Windows 设备](~/docs/cross-platform/media/windowsdevices.png "Windows 设备")
...
##  <a name="HTML"></a>构建面向 Android、iOS 和 Windows 的应用 (HTML/JavaScript)
 ...
 ![多设备混合应用](~/docs/cross-platform/media/multidevicehybridapps.png "多设备混合应用")
...
##  <a name="CPP"></a>构建面向 Android 和 Windows 的应用 (C++)
 ![使用 C++ 构建面向 Android、iOS 和 Windows 的应用](~/docs/cross-platform/media/cross_plat_cpp_intro_image.png "Cross_Plat_CPP_Intro_Image")
 ...
 ![本机活动项目模板](~/docs/cross-platform/media/cross-plat_cpp_native.png "Cross-Plat_CPP_Native")
 ...
 ![静态和动态共享库](~/docs/cross-platform/media/cross_plat_cpp_libraries.png "Cross_Plat_CPP_Libraries")
...
##  <a name="Unity"></a>使用 Visual Studio Tools for Unity 构建面向 Android、iOS 和 Windows 的跨平台游戏
 ...
 ![VSTU 开发环境](~/docs/cross-platform/media/vstu_overview.png "VSTU_Overview")
