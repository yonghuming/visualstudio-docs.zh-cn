---
title:
- "Visual Studio Enterprise 2017 工作负载和组件 ID | Microsoft Docs"
...
* 默认情况下，安装工作负载时将安装**必需**组件。 如果愿意，你还可以安装推荐*和可选**组件。
...
Microsoft.VisualStudio.Component.TestTools.CodedUITest | 编码的 UI 测试
...
Microsoft.VisualStudio.Component.TestTools.MicrosoftTestManager | Microsoft 测试管理器
Microsoft.VisualStudio.Component.TestTools.WebLoadTest | Web 性能和负载测试工具
