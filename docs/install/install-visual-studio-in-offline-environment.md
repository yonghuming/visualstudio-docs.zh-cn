...
对于企业，如果其脱机计算机不具有最新的根证书，则管理员可以按照[此处的说明](https://technet.microsoft.com/en-us/library/dn265983.aspx)更新证书。 或者，可在创建网络布局的过程中将必需的证书下载到 `certificates` 文件夹，然后双击证书文件，再点击完成证书管理器向导，即可手动安装证书。 如果看到输入密码提示，请将密码留空。
...
* 单击“文件”，然后选择“添加/删除管理单元”
  * 双击“证书”，选择“计算机帐户”，然后单击“下一步”
  * 选择“本地计算机”，依次单击“完成”、“确定”
  * 展开“证书(本地计算机)”
  * 展开“受信任的根证书颁发机构”，选择“证书”
    * 检查此列表中是否有必需的根证书。
  * 展开“中间证书颁发机构”，选择“证书”
    * 检查此列表中是否有需要的中间证书。
* 单击“文件”，然后选择“添加/删除管理单元”
  * 双击“证书”，选择“我的用户帐户”，单击“完成”和“确定”。
  * 展开“证书-当前用户”
  * 展开“中间证书颁发机构”，选择“证书”
    * 检查此列表中是否有需要的中间证书。
    
如果证书名称不在“颁发对象”列中，将需要安装这些证书。  如果中间证书仅在“当前用户”中间证书存储中，则仅供已登录的用户使用，其他用户安装后才能使用。
