...
![新建 Web 项目模板](~/python/media/template-web-new-project.png)
...
![为项目模板安装所需包的对话框](~/python/media/template-web-requirements-txt-wizard.png)
...
启动 Web 项目进行调试时，Visual Studio 在本地启动 Web 服务器，并打开默认浏览器浏览至该地址和端口。 若要指定其他选项，请右键单击项目，选择“属性”和“Web 启动器”选项卡：
  ...
  ![常规 Web 模板的 Web 启动器属性](~/python/media/template-web-launcher-properties.png)
...
![在项目的上下文菜单上发布命令](~/python/media/template-web-publish-command.png)
...
![在 Azure 门户上添加站点扩展](~/python/media/template-web-site-extensions.png)
...
![Azure 项模板](~/python/media/template-web-azure-items.png)
...
![更改发布配置](~/python/media/template-web-publish-config.png)
...
![转换为 Microsoft Azure 云服务项目命令](~/python/media/template-web-convert-menu.png)
