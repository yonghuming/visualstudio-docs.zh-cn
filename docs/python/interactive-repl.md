...
![Python 交互窗口](~/docs/python/media/interactive-window.png)
...
![Python 环境窗口中的交互窗口链接](~/docs/python/media/interactive-window-opening.png)

方法二，“视图”>“其他窗口”中针对每个环境都具有**交互窗口**命令，通常显示在菜单底部附近：

![“视图”>“其他窗口”中的交互窗口菜单项](~/docs/python/media/interactive-window-menu.png)

方法三，可以通过选择“调试”>“在 Python 交互窗口中执行 [项目 | 文件]”菜单命令 (Shift+Alt+F5)，打开项目中启动文件的交互窗口，或独立文件的交互窗口：

![在 Python 交互菜单中执行项目](~/docs/python/media/interactive-execute-project.png)
...
![交互窗口的范围](~/docs/python/media/interactive-scopes.png)
...
![Importlib 范围中的交互窗口](~/docs/python/media/interactive-importlib-scope.png)
...
![发送到交互式菜单命令](~/docs/python/media/interactive-send-to.png)
