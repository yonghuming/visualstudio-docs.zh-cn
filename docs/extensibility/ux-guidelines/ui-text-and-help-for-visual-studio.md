...
|好|错误|  
|-------|--------|  
|"您拨打的号码服务中已不存在。 请检查数以及重试或为操作符拨打 0。"|-   "错误 \(: 449\): 非法数字"<br />-   "此未处理的异常错误情况表示操作成功完成"。<br /><br /> ![Bad error message in Visual Studio](~/docs/extensibility/ux-guidelines/media/0602-a_errordialog.png "0602\-a\_ErrorDialog")|  
