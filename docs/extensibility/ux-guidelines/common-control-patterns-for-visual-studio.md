...
![因为内容已经超出了树视图控件的限制，则会显示这两个垂直和水平滚动条。](~/docs/extensibility/ux-guidelines/media/070705-4_scrollbars.png "070705-4_Scrollbars")<br />因为内容已经超出了树视图控件的限制，则会显示这两个垂直和水平滚动条。
