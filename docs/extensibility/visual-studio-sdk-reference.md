...
本部分包含有关 Visual Studio 的命名空间、 相关命名空间和其他感兴趣的主题使用 Visual Studio SDK 的开发人员的信息。  
...
## 本节内容  
 ...
 对于 Visual Studio 命令栏的类。  
  
 <xref:Microsoft.VisualStudio.ComponentModelHost>  
 使用 Visual Studio 中托管可扩展性框架 \(MEF\) 的类。  
 ...
 介绍错误体系结构了的 Vspackage，这是与在其他 Windows 编程中使用的相同。  
  
 [对象](../extensibility/objects.md)  
 提供在环境中使用的对象的列表。  
  
 [词汇表](../extensibility/visual-studio-sdk-glossary.md)  
 如果正在阅读的 Visual Studio SDK 文档，提供有用的术语和定义以供使用的列表。  
  
## 相关章节  
 [Visual Studio SDK](../extensibility/visual-studio-sdk.md)  
 包括文档、 示例和代码以帮助您开发相结合的产品 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 产品系列。