...
<xref:Microsoft.VisualStudio.VSConstants>类时会发布的集成的开发环境 (IDE) 的某些部分 Guid 的下表中列出。</xref:Microsoft.VisualStudio.VSConstants>  
...
## <a name="broadly-visible-components"></a>广泛可视组件  
...
## <a name="miscellaneous-shell-guids"></a>杂项命令行程序的 Guid  
