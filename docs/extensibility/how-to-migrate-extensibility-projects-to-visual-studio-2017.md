...
![VSSDK 生成工具](~/docs/extensibility/media/vssdk-build-tools.png)
...
* 选择**先决条件**选项卡，然后按**新建**按钮。
  ...
  ![VSIX 清单设计器](~/docs/extensibility/media/vsix-manifest-designer.png)

* **添加新系统必备**将会打开窗口。

  ![添加 vsix 必备组件](~/docs/extensibility/media/add-vsix-prerequisite.png)
...
* 如果需要，更新的版本。
  ...
  ![添加 roslyn 必备组件](~/docs/extensibility/media/add-roslyn-prerequisite.png)
...
![启动外部程序](~/docs/extensibility/media/start-external-program.png)
...
![在 Visual Studio 2017 VSIX 安装程序](~/docs/extensibility/media/vsixinstaller-vs-2017.png)
...
![正在运行的进程的 vs](~/docs/extensibility/media/vs-running-processes.png)
...
![vsixinstaller 缺少的先决条件](~/docs/extensibility/media/vsixinstaller-missing-prerequisite.png)
