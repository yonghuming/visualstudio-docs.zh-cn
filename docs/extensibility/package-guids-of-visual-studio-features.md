---
title: "包的 Visual Studio 功能 Guid |Microsoft 文档"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
||Visual Studio 环境程序包|{DA9FB551-C724-11d0-AE1F-00A0C90FFFC3}|  
||Visual Studio 命令定义程序包|{44E07B02-29A5-11D3-B882-00C04F79F802}|  
||Visual Studio Directory Listing Package|{5010C52F-44AB-4051-8CE1-D36C20D989B4}|  
||Visual Studio 常见 IDE 程序包|{6E87CFAD-6C05-4ADF-9CD7-3B7943875B7C}|  
||Visual Studio 环境菜单程序包|{715F10EB-9E99-11D2-BFC2-00C04F990235}|  
...
||Visual Studio VsSettings 程序包|{F74C5077-D848-4630-80C9-B00E68A1CA0C}|  
|帮助|Visual Studio Help Package|{4A791146-19E4-11D3-B86B-00C04F79F802}|  
|任务列表中，错误列表|ErrorListPackage|{4A9B7E50-AA16-11D0-A8C5-00A0C921A4D2}|  
|类概述|Class Outline Package|{21AF45B0-FFA5-11 D&0;-G63F-00A0C922E851}|  
...
|HTML 编辑器|Visual Studio HTM Editor Package|{1B437D20-F8FE-11D2-A6AE-00104BCC7269}|  
||Visual Web Developer HTML Source Editor Package|{BFCC0C3C-6F87-4285-A6C8-BB616061800D}|  
|CSS 编辑器|Visual Studio CSS Editing Package|{A764E895-518D-11d2-9A89-00C04F79EFC3}|  
|XML 编辑器|Visual Studio XML Editor Package|{87569308-4813-40A0-9CD0-D7A30838CA3F}|  
|Web 浏览器|Visual Studio Web Browser Package|{E8B06F41-6D01-11D2-AA7D-00C04F990343}|  
||Web 应用程序项目工厂的 View 的浏览器的功能|{349C5851-65DF-11DA-9384-00065B846F21}|  
|二进制编辑器|Visual Studio Binary Editor Package|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|  
...
|数据库工具|Visual Database Tools Package|{220A4C17-7E7C-4663-BBCC-5E607C6543CD}|  
...
||Microsoft 报告设计器|{F3A96850-E2AE-4E00-9278-8FE23F225A0D}|  
...
|SourceSafe 支持|Visual SourceSafe Provider Package|{AA8EB8CD-7A51-11D0-92C3-00A0C9138C45}|  
...
|代码段|Visual Studio Code Snippets Package|{0B680757-2C29-4531-80FA-535A5178AA98}|  
|托管语言项目支持|Visual Studio 组件枚举器|{588205E0-66e0-11D3-8600-00C04F6123B3}|  
||Visual Studio Settings and Project Designers Package|{67909B06-91E9-4F3E-AB50-495046BE9A9A}|  
|导出模板...|Export Template Package|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|  
  
 应永远不会删除某些包，因为很多其他功能对其采取依赖关系。 例如，应永远不会删除在"核心 IDE"之下列出的。  
  
 不能完全删除一些功能。 例如，没有可以注销删除程序包**类视图**和其关联的菜单、 选项和服务。 **类视图**窗口提供的 Visual Studio 环境包，它还提供了其他关键 IDE 功能。 如果你想要删除**类视图**，您还需要删除**查找和替换**，环境**选项**页，**命令窗口**，和**输出**窗口。
