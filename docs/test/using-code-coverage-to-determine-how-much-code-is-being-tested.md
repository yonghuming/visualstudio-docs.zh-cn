...
2.  若要查看已运行的行，请选择![“显示代码覆盖率着色”图标](~/docs/test/media/codecoverage-showcoloringicon.png "CodeCoverage-ShowColoringIcon")**显示代码覆盖率着色**。  
...
## <a name="merging-results-from-different-runs"></a>合并不同运行的结果  
 ...
 为此，请使用![“代码覆盖率”窗口中“合并”按钮的图标](~/docs/test/media/codecoverage-mergeicon.png "CodeCoverage-MergeIcon")**合并代码覆盖率结果**。 你可以选择最近的运行或导入的结果的任意组合。 如果要组合导出的结果，则必须先将其导入。  
