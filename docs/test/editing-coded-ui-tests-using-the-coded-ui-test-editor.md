...
编辑控件属性  
 ...
 修改完后，选择 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 工具栏上的“保存”，将所做更改保存到 UIMap.Designer 文件中。  
...
##  <a name="CodedUITestEditor_SplitMethods"></a>将一个测试方法拆分成两个不同方法  
 ...
 拆分完方法后，选择 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 工具栏上的“保存”，将所做更改保存到 UIMap.Designer 文件中。  
...
##  <a name="CodedUITestEditor_MoveMethods"></a>为了方便自定义，将测试方法移到 UIMap 文件中  
 ...
 移完方法后，选择 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 工具栏上的“保存”，将所做更改保存到 UIMap.Designer 文件中。  
...
##  <a name="CodedUITestEditor_LocateUIControl"></a>在受测应用中查找 UI 控件  
...
##  <a name="CodedUITestEditor_InsertDelay"></a>在 UI 操作前插入延迟  
 ...
 插入完延迟后，选择 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 工具栏上的“保存”，将所做更改保存到 UIMap.Designer 文件中。  
