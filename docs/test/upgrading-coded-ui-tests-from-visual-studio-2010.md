...
> [!NOTE]
>  Visual Studio 包括多个测试项目类型。 如果创建新的编码 UI 测试，将在编码 UI 测试项目类型中创建。 有关详细信息，请参见[从 Visual Studio 的早期版本升级测试](http://msdn.microsoft.com/zh-cn/e9c8b7f6-bd72-448e-8edb-d090dcc5cf52)。  
...
##  <a name="UpgradingCodedUIFromVS2010_Update"></a> Visual Studio 2010 SP1 更新  
 可从 [Microsoft 下载中心](http://www.microsoft.com/download/details.aspx?id=34677)下载为 Visual Studio 2012 和 Windows 8 提供兼容性支持的 [!INCLUDE[vs2010](../modeling/includes/vs2010_md.md)] SP1 更新，该更新也可用作 Visual Studio 更新。  
  
 应用更新以后，以下 [!INCLUDE[vs2010](../modeling/includes/vs2010_md.md)] SP1 编码 UI 测试工具功能将针对 Windows 8 有所改进：  
...
-   **代码覆盖率：**无法在 [!INCLUDE[vs2010](../modeling/includes/vs2010_md.md)] SP1 中打开由 Visual Studio 2012 创建的代码覆盖率文件 \(.coverage\)。  
...
## 请参阅  
 ...
 [从 Visual Studio 的早期版本升级测试](http://msdn.microsoft.com/zh-cn/e9c8b7f6-bd72-448e-8edb-d090dcc5cf52)   
