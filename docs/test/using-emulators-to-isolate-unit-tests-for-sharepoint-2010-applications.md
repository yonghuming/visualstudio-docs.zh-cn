---
title: "使用模拟器分离 Sharepoint 2010 应用程序的单元测试 | Microsoft Docs"
ms.custom: ""
ms.date: "12/11/2016"
...
manager: "douge"
---
# 使用模拟器分离 Sharepoint 2010 应用程序的单元测试
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Microsoft.SharePoint.Emulators 包提供了一组帮助你对 Microsoft SharePoint 2010 应用程序创建独立单元测试的库。  仿真程序使用 [Microsoft Fakes](../test/isolating-code-under-test-with-microsoft-fakes.md) 独立框架中的[填充码](../test/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md)来创建轻量内存对象，以模仿 SharePoint API 的最常见对象和方法。  当未仿真 SharePoint 方法，或者当你想要更改仿真程序的默认行为时，可以通过创建 Fakes 填充码来提供所需的结果。  
...
-   [将 Emulators 程序包添加到测试项目](#BKMK_Adding_the_Emulators_package_to_a_test_project)  
  
-   [运行带有仿真的测试方法](#BKMK__Running_a_test_method_in_the_emulation_context)  
 ...
 [处理非模拟的 SharePoint 方法](#BKMK_Handling_non_emulated_SharePoint_methods)  
  
 [从头开始编写仿真测试和摘要](#BKMK_Writing_emulation_tests_from_scratch__and_a_summary)  
  
 [示例](#BKMK_Example)  
  
 [模拟的 SharePoint 类型](#BKMK_Emulated_SharePoint_types)  
...
-   Microsoft SharePoint 仿真程序 NuGet 包  
 ...
 你还应熟悉 [Visual Studio 中的单元测试基础知识](../test/unit-test-basics.md)以及 [Microsoft Fakes](../test/isolating-code-under-test-with-microsoft-fakes.md) 的一些知识。  
  
##  <a name="BKMK_The_AppointmentsWebPart_example"></a> AppointmentsWebPart 示例  
 AppointmentsWebPart 允许你查看和管理 SharePoint 约会列表。  
  
 ![约会 Web 部件](../test/media/ut_emulators_appointmentswebpart.png "UT\_EMULATORS\_AppointmentsWebPart")  
...
###  <a name="BKMK_Adding_the_Emulators_package_to_a_test_project"></a> 将 Emulators 程序包添加到测试项目  
 将 SharePoint 仿真程序添加到测试项目：  
  
1.  在解决方案资源管理器中选择测试项目。  
  
2.  在快捷菜单上选择**“管理 NuGet 包...”**。  
  
3.  搜索 `Microsoft.SharePoint.Emulators` 的**“联机”**类别，然后选择**“安装”**。  
  
 ![Sharepoint 仿真器 NuGet 包](../test/media/ut_emulators_nuget.png "UT\_EMULATORS\_Nuget")  
  
 [主题内容](#BKMK_In_this_topic)  
  
###  <a name="BKMK__Running_a_test_method_in_the_emulation_context"></a> 运行带有仿真的测试方法  
...
```  
 ...
 ![仿真器执行流](../test/media/ut_emulators_flowchart.png "UT\_EMULATORS\_FlowChart")  
...
##  <a name="BKMK_Handling_non_emulated_SharePoint_methods"></a> 处理非模拟的 SharePoint 方法  
...
1.  如果希望填充非仿真 SharePoint 类，请编辑 Microsoft.SharePoint.fakes 文件并将该类添加到已填充类的列表。  请参阅 [Microsoft Fakes 中的代码生成、编译和命名约定](../test/code-generation-compilation-and-naming-conventions-in-microsoft-fakes.md)的[配置存根和填充码的代码生成](http://msdn.microsoft.com/library/hh708916.aspx#bkmk_configuring_code_generation_of_stubs)部分。  
  
     ![解决方案资源管理器中的 Fakes 文件夹](../test/media/ut_emulators_fakesfilefolder.png "UT\_EMULATORS\_FakesFileFolder")  
  
2.  安装 Microsoft SharePoint 仿真程序包后，如果你已编辑 Microsoft.SharePoint.Fakes 文件，请重新生成测试项目至少一次。  生成项目时将创建 **FakesAssembly** 文件夹并将其填充到磁盘上的项目根文件夹下。  
  
     ![FakesAssembly 文件夹](../test/media/ut_emulators_fakesassemblyfolder.png "UT\_EMULATORS\_FakesAssemblyFolder")  
  
3.  添加对位于 **FakesAssembly** 文件夹中的 **Microsoft.SharePoint.14.0.0.0.Fakes.dll** 程序集的引用。  
...
##  <a name="BKMK_Writing_emulation_tests_from_scratch__and_a_summary"></a> 从头开始编写仿真测试和摘要  
...
##  <a name="BKMK_Emulated_SharePoint_types"></a> 模拟的 SharePoint 类型  
