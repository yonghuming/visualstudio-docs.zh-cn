---
title: "使用 Visual Studio 静态代码分析来分析应用商店应用的代码质量 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# 使用 Visual Studio 静态代码分析来分析应用商店应用的代码质量
...
|[分析 C\+\+ 代码质量](../test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)|在 C\+\+ 项目中使用代码分析。|  
