...
# 如何：用数据库中的数据填充工作表
 ...
 ![链接到视频](~/docs/data-tools/media/playvideo.gif "链接到视频") 如需相关视频演示，请参见 [How Do I: Transfer Data Into an Excel Worksheet?](http://go.microsoft.com/fwlink/?LinkID=130277)（如何实现：将数据传输到 Excel 工作表？）以及 [How Do I: Consume Database Data in Excel?](http://go.microsoft.com/fwlink/?LinkID=130287)（如何实现：在 Excel 中使用数据库数据？）。  
