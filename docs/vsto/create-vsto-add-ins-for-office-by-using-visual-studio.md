...
> [!NOTE]  
>  了解如何使用全新 [Office 外接程序模型](https://msdn.microsoft.com/en-us/library/office/jj220082.aspx)来扩展你的用户的 Office 体验。 与 VSTO 外接程序和解决方案相比，这些外接程序的需求量很小，几乎可以使用任何 Web 编程技术（例如 HTML5、JavaScript、CSS3 和 XML）生成。  
...
## 相关章节  
 ...
 [Visual Studio 中的 .NET Framework 编程](http://msdn.microsoft.com/zh-cn/f3f63195-82c6-48e8-a4a0-612810e7d093)  
