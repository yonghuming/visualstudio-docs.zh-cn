---
title: "如何：向 VBA 公开 Visual Basic 项目中的代码 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
-   [公开不在宿主项类中的代码](#NonHostItem)  
 ...
 ![链接到视频](../vsto/media/playvideo.png "链接到视频") 有关相关的视频演示，请参见 [How Do I: Call VSTO Code from VBA?](http://go.microsoft.com/fwlink/?LinkId=136757)（如何实现：从 VBA 调用 VSTO 代码）。  
