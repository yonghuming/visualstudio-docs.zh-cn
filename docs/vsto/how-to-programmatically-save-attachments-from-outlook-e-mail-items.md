---
title: "如何：以编程方式保存 Outlook 电子邮件项的附件 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Outlook [Visual Studio 中的 Office 开发]，附件"
  - "电子邮件 [Visual Studio 中的 Office 开发]，附件"
  - "保存电子邮件附件"
  - "邮件项 [Visual Studio 中的 Office 开发]，附件"
  - "附件 [Visual Studio 中的 Office 开发]"
...
> [!IMPORTANT]  
>  要让此示例正常运行，必须在 C 目录的根目录下添加名为 **TestFileSave** 的文件夹。  
