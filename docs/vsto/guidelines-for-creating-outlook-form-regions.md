---
title: "Outlook 窗体区域创建准则 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "窗体区域 [Visual Studio 中的 Office 开发]，准则"
  - "图标 [Visual Studio 中的 Office 开发]"
...
-   [使用最佳图标大小](#UsingOptimal)。  
 ...
 有关窗体区域的更多信息，请参阅[创建 Outlook 窗体区域](../vsto/creating-outlook-form-regions.md)。  
...
##  <a name="DisablingInheritance"></a> 禁用窗体区域继承  
 ...
 如果不希望窗体区域与任何派生的 message 类关联，将窗体区域的 <xref:Microsoft.Office.Tools.Outlook.FormRegionManifest.ExactMessageClass%2A> 属性设置为 **true**。 例如，如果将一个相邻的窗体区域与 IPM.Task 关联并将 <xref:Microsoft.Office.Tools.Outlook.FormRegionManifest.ExactMessageClass%2A> 属性设置为 **true**，窗体区域只会追加到标准任务窗体的底部。 窗体区域不会追加到任何自定义版本的标准任务窗体的底部。  
