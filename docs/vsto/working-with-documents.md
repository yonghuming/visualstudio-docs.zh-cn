...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "文档 [Visual Studio 中的 Office 开发], 常规任务"
  - "Office 文档 [Visual Studio 中的 Office 开发, 常规任务"
  - "Word [Visual Studio 中的 Office 开发], 文档常规任务"
...
|删除文档中的所有注释。|[如何：以编程方式移除文档中的所有注释](../vsto/how-to-programmatically-remove-all-comments-from-documents.md)|  
