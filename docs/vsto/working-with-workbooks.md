...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "工作簿 [Visual Studio 中的 Office 开发]，常规任务"
...
|将文本文件打开为工作簿。|[如何：以编程方式及工作簿形式打开文本文件](../vsto/how-to-programmatically-open-text-files-as-workbooks.md)|  
