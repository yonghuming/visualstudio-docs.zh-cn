...
# XmlMappedRange 控件
 ...
 ![链接到视频](~/docs/data-tools/media/playvideo.gif "链接到视频") 有关相关视频演示，请参见 [How Do I: Use XML Mapping in Excel?](http://go.microsoft.com/fwlink/?LinkID=130288)（如何实现：在 Excel 中使用 XML 映射？）。  
