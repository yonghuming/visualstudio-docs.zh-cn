...
helpviewer_keywords: 
  - "Office 主互操作程序集, 安装"
  - "主互操作程序集 [Visual Studio 中的 Office 开发], 安装"
...
2.  安装 Microsoft Office，并确保为你想要扩展的应用程序选择“.NET 可编程性支持”功能（默认安装中包括此功能）。  
  
    > [!WARNING]  
    >  默认情况下，当你生成 PIA 时它们就已嵌入到了你的解决方案中，因此你不必将 PIA 分发给用户来作为使用 VSTO 外接程序或自定义项的先决条件。  
