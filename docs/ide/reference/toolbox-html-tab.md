 ...
 **指针**  
 ![ASP.NET 移动设计器 HTML 页指针](~/docs/ide/reference/media/vxpointer.gif "vxPointer")  

 打开任一工具箱选项卡时，此工具默认处于选中状态。 无法删除此工具。 使用指针可将对象拖动到“设计”视图图面上、调整其大小，并在页面或窗体中对其重新定位。 有关详细信息，请参阅[使用工具箱](../../ide/using-the-toolbox.md)。  

 **Input (Button)**  
 ![HTML 网页按钮](~/docs/ide/reference/media/vxbutton.gif "vxButton")  
 ...
 **Input (Reset)**  
 ![HTMLpageResetButton 屏幕截图](~/docs/ide/reference/media/vxreset.gif "vxReset")  
 ...
 **Input (Submit)**  
 ![HTMLpageToolbarSubmitButton 屏幕截图](~/docs/ide/reference/media/vxsubmit.gif "vxSubmit")  
 ...
 **Input (Text)**  
 ![HTMLpageToolbarTextField 屏幕截图](~/docs/ide/reference/media/vxtextfield.gif "vxTextfield")  
 ...
 **Input (File)**  
 ![HTML 页文件字段](~/docs/ide/reference/media/vxfilefield.gif "vxFilefield")  
 ...
 **Input (Password)**  
 ![Visual Studio 密码字段](~/docs/ide/reference/media/vxpassword.gif "vxPassword")  
 ...
 **Input (Check box)**  
 ![HTML 网页工具箱复选框选项](~/docs/ide/reference/media/vxcheckbox.gif "vxCheckbox")  
 ...
 **Input (Radio)**  
 ![VisualStudioHTMLpageRadioButton 屏幕截图](~/docs/ide/reference/media/vxradio.gif "vxRadio")  
 ...
 **Input (Hidden)**  
 ![HTML 页隐藏项](~/docs/ide/reference/media/vxhidden.gif "vxhidden")  
 ...
 **Textarea**  
 ![HTML 页工具栏文本区域](~/docs/ide/reference/media/vxtextarea.gif "vxTextarea")  
 ...
 **Table**  
 ![HTMLpageToolbarTable 屏幕截图](~/docs/ide/reference/media/vxtable.gif "vxTable")  
...
**Image**  
 ![HTML 页图像项](~/docs/ide/reference/media/vximage.gif "vxImage")  
 ...
 **选择**  
 ![HTML 页工具箱下拉列表](~/docs/ide/reference/media/vxdropdown.gif "vxDropdown")  
 ...
 **Horizontal Rule**  
 ![HTML 页水平标尺项](~/docs/ide/reference/media/vxhorizontal.gif "vxHorizontal")  
 ...
 **Div**  
 ![HTML 页标签](~/docs/ide/reference/media/vxlabel.gif "vxLabel")  
