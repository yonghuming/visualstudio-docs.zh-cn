...
### <a name="configuring-a-build"></a>配置生成  
 ...
 ![Visual Studio 调试生成按钮](~/docs/ide/media/vs_ide_gs_debug_build_type1.PNG "Vs_ide_gs_debug_build_type1")  
 ...
 ![Visual Studio“配置文件管理器”窗口](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr.PNG "Vs_ide_gs_debug_build_cf_mgr")  

 可以使用“配置管理器”指定要面向的生成配置。 启动管理器，单击“配置”或“CPU”下拉列表，然后选择“新建...”，创建新的生成或平台。  

 ![Visual Studio“配置管理器”窗口](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr_2.PNG "Vs_ide_gs_debug_build_cf_mgr_2")  
...
### <a name="building-your-code"></a>生成你的代码  
 ...
 ![Visual Studio 生成项目菜单选择](~/docs/ide/media/vs_ide_gs_debug_build_menu_item.png "Vs_ide_gs_debug_build_menu_item")  
 ...
 ![Visual Studio 成功的生成输出](~/docs/ide/media/vs_ide_gs_debug_success_build.PNG "vs_ide_gs_debug_success_build")  
...
### <a name="reviewing-the-error-list"></a>审阅错误列表  
 ...
 ![Visual Studio 输出和错误列表](~/docs/ide/media/vs_ide_gs_debug_bad_build_error_list.PNG "Vs_ide_gs_debug_bad_build_error_list")  

 单击“错误列表”窗口中的错误行，并跳转至发生错误的行。 （或单击右上方的“快速启动”栏，在其中键入行号，然后按 Enter，以打开行号。 这是转至“选项”窗口条目最快的方法，你可以在这里打开行号。 了解如何使用“快速启动”栏，可以省去多次单击 UI！）  

 ![具有行号的 Visual Studio 编辑器](~/docs/ide/media/vs_ide_gs_debug_line_numbers.png "Vs_ide_gs_debug_line_numbers")  

 ![Visual Studio 行号选项](~/docs/ide/media/vs_ide_gs_debug_options_line_numbers.png "Vs_ide_gs_debug_options_line_numbers")  

 使用 Ctrl+G 快速跳转至发生错误的行号。  

 错误由红色的“波形曲线”下划线标识。 将鼠标悬停在下划线上以获取其他详细信息。 修复后下划线消失，尽管纠正过程中可能会引入新的错误。 （此过程被称为“回归”。）  

 ![Visual Studio 错误悬停](~/docs/ide/media/vs_ide_gs_debug_error_hover1.png "Vs_ide_gs_debug_error_hover1")  

 遍历错误列表，并解决代码中的所有错误。  

 ![Visual Studio 调试错误窗口](~/docs/ide/media/vs_ide_gs_debug_error_list.PNG "Vs_ide_gs_debug_error_list")  
...
### <a name="reviewing-errors-in-detail"></a>审阅错误的详细信息  
 ...
 ![Visual Studio 错误列表的必应搜索](~/docs/ide/media/vs_ide_gs_debug_error_list_error_help.png "Vs_ide_gs_debug_error_list_error_help")  
...
### <a name="performing-static-code-analysis"></a>执行静态代码分析  
 ...
 ![Visual Studio 代码分析菜单项](~/docs/ide/media/vs_ide_gs_debug_run_code_analysis.png "Vs_ide_gs_debug_run_code_analysis")  

 任何新的或更新的警告都将显示在 IDE 底部的“错误列表”选项卡中。 单击警告以跳转到相应的行。  

 ![带警告的 Visual Studio 错误列表](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_error_list.PNG "vs_ide_gs_debug_code_analysis_warning_error_list")  

 警告将用明亮的黄绿色（而非红色）波形曲线标识。 将鼠标悬停在波形曲线上方以获取详细信息，右键单击波形曲线获取获取上下文菜单以帮助修复或重构选项。  

 ![Visual Studio 代码分析警告悬停](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_hover.png "vs_ide_gs_debug_code_analysis_warning_hover")  
...
### <a name="using-light-bulbs-to-fix-or-refactor-code"></a>使用灯泡修复或重构代码  
 ...
 ![Visual Studio 灯泡快速选项](~/docs/ide/media/vs_ide_gs_debug_light_bulb1.png "Vs_ide_gs_debug_light_bulb1")  

 你将看到可应用于代码行的可能修复或重构方法列表。  

 ![Visual Studio 灯泡预览](~/docs/ide/media/vs_ide_gs_debug_light_bulb_preview_changes.PNG "Vs_ide_gs_debug_light_bulb_preview_changes")  
 ...
 ![Visual Studio 灯泡“无选项”文本](~/docs/ide/media/vs_ide_gs_debug_light_bulb_no_options.PNG "Vs_ide_gs_debug_light_bulb_no_options")  
...
### <a name="debugging-your-running-code"></a>调试运行代码  
 ...
 ![Visual Studio 自动和调用堆栈窗口](~/docs/ide/media/vs_ide_gs_debug_autos_and_call_stack.PNG "Vs_ide_gs_debug_autos_and_call_stack")  

 用你的应用尝试各种操作，然后观察更改。 如果出现异常，请按 Ctrl + Alt + Break 暂停应用程序（或单击“暂停”按钮）。  

 ![Visual Studio“全部中断”按钮](~/docs/ide/media/vs_ide_gs_debug_break_all_button.png "vs_ide_gs_debug_break_all_button")  

 按 F5 继续运行应用程序（或单击“继续”按钮）。  

 ![Visual Studio“继续调试”按钮](~/docs/ide/media/vs_ide_gs_debug_continue_button.png "Vs_ide_gs_debug_continue_button")  
...
### <a name="setting-simple-breakpoints"></a>设置简单断点  
 ...
 ![Visual Studio 断点](~/docs/ide/media/vs_ide_gs_debug_breakpoint1.png "Vs_ide_gs_debug_breakpoint1")  
...
### <a name="setting-conditional-breakpoints"></a>设置条件断点  
 ...
 ![Visual Studio 断点设置](~/docs/ide/media/vs_ide_gs_debug_breakpoint_settings.png "Vs_ide_gs_debug_breakpoint_settings")  

 你将看到如下对话框，可以在此对话框中为中断的发生设置特定条件。  

 ![Visual Studio 条件断点](~/docs/ide/media/vs_ide_gs_debug_breakpoint_conditional.PNG "Vs_ide_gs_debug_breakpoint_conditional")  
...
### <a name="inspecting-your-code-at-run-time"></a>在运行时检查你的代码  
 ...
 ![Visual Studio 运行时值检查](~/docs/ide/media/vs_ide_gs_debug_inspect_value.PNG "vs_ide_gs_debug_inspect_value")  
 ...
 ![Visual Studio“诊断工具”窗口](~/docs/ide/media/vs_ide_gs_debug_diagnostic_tools.PNG "Vs_ide_gs_debug_diagnostic_tools")  
