...
通过更改选项，可在普通编辑器或特定语言编辑器中自定义格式、选项卡、字体和颜色、IntelliSense 及更多其他功能。  有关这些选项的详细信息，请参阅[“选项”对话框 \-\>“文本编辑器”](../ide/reference/text-editor-options-dialog-box.md)，或在**“快速启动”**中键入`“编辑器”`。  还可以更改编辑器窗口的显示方式。  
