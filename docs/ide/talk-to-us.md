...
## <a name="i-want-to-report-a-problem-with-visual-studio"></a>我想报告 Visual Studio 的问题  
 如果使用 Visual Studio 时遇到如崩溃、性能缓慢、意外行为等问题，请使用**报告问题**工具将问题报告给我们。 只需单击“快速启动”旁边的反馈图标，或从主菜单中选择“帮助”&#124;“发送反馈”&#124;“报告问题”。 有关详细信息，请参阅[如何报告 Visual Studio 2017 RC 的问题](how-to-report-a-problem-with-visual-studio-2017.md)。  
...
有关 Visual Studio 支持选项，请参阅我们的[支持概述](http://www.visualstudio.com/support/support-overview-vs)页。
