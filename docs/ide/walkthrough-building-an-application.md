...
3.  在“新建解决方案配置”对话框中，命名新配置 `Test`，复制现有“调试”配置中的设置，然后选择“确定”按钮。  
     ...
     ![“新建解决方案配置”对话框](~/docs/ide/media/buildwalk_newsolutionconfigdlgbox.png "BuildWalk_NewSolutionConfigDlgBox")  
  
4.  在“活动解决方案平台”列表中，选择“新建”。  
  
5.  在“新建解决方案平台”对话框中，选择“x64”，且不要复制 x86 平台中的设置。  
  
     ![“新建解决方案平台”对话框](~/docs/ide/media/buildwalk_newsolutionplatform.png "BuildWalk_NewSolutionPlatform")  
...
-   在菜单栏上，依次选择 **“生成”**、 **“生成解决方案”**。  
 ...
 ![“输出”窗口 Visual Basic](~/docs/ide/media/buildwalk_vbbuildoutputwnd.png "BuildWalk_VBBuildOutputWnd")  
...
4.  生成解决方案。  
 ...
 ![“Visual Basic 生成警告”->“输出”窗口](~/docs/ide/media/buildwalk_visualbasicbuildwarnings.png "BuildWalk_VisualBasicBuildWarnings")  
