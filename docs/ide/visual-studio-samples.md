...
|[](http://code.msdn.microsoft.com/site/search?f%5B0%5D.Type=ProgrammingLanguage&f%5B0%5D.Value=C%2B%2B)|演示如何使用 C++ 中的不同功能。|  
...
|[Office 开发示例](/office-dev/office-dev/office-development-samples)|演示如何使用 Visual Studio 中的 Office 开发工具。 有关最新示例的信息，请参阅 [MSDN 开发人员示例：通过代码学习](http://go.microsoft.com/fwlink/?LinkID=248199)。|  
