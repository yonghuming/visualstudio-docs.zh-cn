...
1.  创建新项目。 在菜单栏上，依次选择“文件”、“新建”、“项目...”。  
     ...
     ![在“快速启动”框中，指定新项目](~/docs/ide/media/exploreide-quicklaunchnewprojectsmall.png "ExploreIDE QuickLaunchNewProjectsmall")  
...
2.  例如，通过在左窗格 **已安装**、 **模板**、 **Visual C#**、 **Windows**中进行选择，然后选择中间窗格中的 WPF 应用程序，以选择 Visual Basic 或 Visual C# WPF 应用程序模板。  命名新项目对话框底部的项目 HelloWPFApp。  
 ...
 ![已加载 HelloWPFApp 文件的解决方案资源管理器](~/docs/ide/media/exploreide-hellowpfappfiles.png "ExploreIDE-HelloWPFAppFiles")  
...
1.  在下面的过程中，需为 MainWindow 提供更具体的名称。 在 **“解决方案资源管理器”**中，选择 MainWindow.xaml。 此时应看到“属性”窗口，如果没有，请依次选择“视图”菜单和“属性窗口”项。 将 **“文件名称”** 属性更改为 `Greetings.xaml`。  
     ...
     ![突出显示文件名的“属性”窗口](~/docs/ide/media/exploreide-filenameinpropertieswindow.png "ExploreIDE FilenameinPropertiesWindow")  
...
2.  使用工具栏（当前显示“调试”）上的下拉列表控件把 HelloWPFApp 的生成配置从“调试”更改为“发布”。  
     ...
     ![选定了“发布”的“标准”工具栏](~/docs/ide/media/exploreide-releaseversion.png "ExploreIDE-ReleaseVersion")  
