...
![代码编辑器](~/docs/ide/media/VSIDE_CodeWindow.png)
...
![解决方案资源管理器折叠节点](~/docs/ide/media/VSIDE_SolutionExplorer2_callouts.png)

 展开项目节点时，除了解决方案和项目，解决方案资源管理器还会列出每个项目中的所有文件。 每个项目包含一个或多个文件，如源代码文件和资源文件（如图像或库）。

![“解决方案资源管理器”](~/docs/ide/media/VSIDE_SolutionExplorer3.png)

若要查看解决方案、项目和文件的属性，请在快捷方式（右键单击）菜单上选择“属性”命令，或选择菜单上的“视图”-“属性”窗口。

![“属性”窗口](~/docs/ide/media/VSIDE_SolutionExplorer4.png)
...
![Visual Studio 工具栏](~/docs/ide/media/VSIDE_SolutionExplorer5_callouts.png)
...
![“输出”窗口](~/docs/ide/media/VSIDE_OutputWindow.png)
