...
- **启用轻型解决方案加载**
    ...
    在此模式下，没有启用某些 IDE 功能。 要确定此选择是否有所帮助，请参阅 [Shorter solution load time](https://blogs.msdn.microsoft.com/visualstudio/2016/10/11/shorter-solution-load-time-in-visual-studio-15/)（更短的解决方案加载时间）和[优化 Visual Studio 启动时间](https://docs.microsoft.com/en-us/visualstudio/ide/optimize-visual-studio-startup-time#speed-up-solution-load)。
