...
项目具有一些控制编译、调试、测试和部署的很多方面的属性。 有些属性在所有项目类型中是通用的，而有些则只用于特定语言或平台。 右键单击解决方案资源管理器中的项目节点并选择属性，或者将属性键入菜单栏中的“快速启动”搜索框，可访问项目属性。  
 ...
 ![项目上下文菜单](~/docs/ide/media/vs2015_proj_prop_menu.gif "vs2015_proj_prop_menu")  
  
 在项目树本身，.NET 项目也可能具有一个属性节点。  
  
 ![解决方案资源管理器树中的属性节点](~/docs/ide/media/vs2015_props_se.png "VS2015_Props_SE")  
...
### <a name="c-visual-basic-and-f-projects"></a>C#、Visual Basic 和 F# 项目  
 ...
 ![Visual Studio 项目设计器](~/docs/ide/media/vs2015_proppage_build.png "VS2015_PropPage_Build")  
...
### <a name="c-and-javascript-projects"></a>C++ 和 JavaScript 项目  
 ...
 ![Visual C++ 项目属性](~/docs/ide/media/vs2015_projprops_cpp.png "VS2015_ProjProps_cpp")  
