...
2.  将下面的代码添加到“Fill in the subtraction problem”注释之后。  
     ...
     ![Intellisense 窗口工具提示](~/docs/ide/media/express_overloads.png "Express\_Overloads")  
Intellisense 窗口工具提示  
     ...
     ![IntelliSense 中 Next&#40;&#41; 方法的重载](~/docs/ide/media/express_nextoverload.png "Express\_NextOverload")  
