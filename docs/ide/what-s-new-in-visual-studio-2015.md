...
## 新的安装体验  
 ...
 ![Visual Studio 2015 安装对话框](~/docs/ide/media/vs2015_setup_screen.png "VS2015\_Setup\_screen")  
...
## 设备预览菜单栏  
 ...
 ![“设备预览”菜单](~/docs/ide/media/vs2015_device_preview.png "vs2015\_device\_preview")  
...
4.  销售团队  
 ...
 ![添加已连接的服务对话框](~/docs/ide/media/vs2015_addconnectedservicedialog.png "VS2015\_AddConnectedServiceDialog")  
...
### 高分辨率图像和触摸屏支持  
 ...
 ![编辑器中的触控支持](~/docs/ide/media/vs2015_touchsupport.png "VS2015\_TouchSupport")  
 ...
 **代码图和依赖项关系图**  
 ...
 ![显示新代码映射上的选定项](~/docs/ide/media/codemapsshowonnewmap.png "CodeMapsShowOnNewMap")  
