...
>  CodeLens 仅在 Visual Studio Enterprise 和 Visual Studio Professional 版中可用。 在 Visual Studio Community 版中不可用。  
 ...
 若要选择想要查看的指示器或者要关闭和打开 CodeLens，请依次转到“工具”、“选项”、“文本编辑器”、“所有语言”、“CodeLens”。  
...
-   Visual C\# .NET 或 Visual Basic .NET 代码  
 ...
 ![CodeLens &#45; 选取引用](../ide/media/codelensviewreferencespeekreference.png "CodeLensViewReferencesPeekReference")  
  
 若要打开包含该引用的文件，请双击该引用。  
  
 若要查看此代码与其引用之间的关系，[创建代码图](../modeling/map-dependencies-across-your-solutions.md)并在代码图快捷菜单中选择**“显示所有引用”**。  
...
-   [Lync 2010 或更高版本、或 Skype for Business](http://technet.microsoft.com/en-us/lync)，可从代码编辑器联系你的团队  
 ...
 ![代码元素级别指示器](../ide/media/codelenselementlevelindicators.png "CodeLensElementLevelIndicators")  
  
 对于可在 Visual Studio 编辑器中打开的所有其他类型的文件，在窗口底部的某个位置获取整个文件的 CodeLens 详细信息（*文件级*指示器）。  
  
 ![文件级别 CodeLens 指示器](../ide/media/almcodelensfilelevelindicators.png "ALMCodeLensFileLevelIndicators")  
...
### 查找你的代码中的更改  
 ...
 默认时间段为最近 12 个月。 如果你的代码存储在 Team Foundation Server 中，则可以通过运行具有 [CodeIndex 命令](../ide/codeindex-command.md)和 **\/indexHistoryPeriod** 标志的 [TFSConfig 命令](http://msdn.microsoft.com/zh-cn/94424190-3b6b-4f33-a6b6-5807f4225b62)来对此进行更改。  
...
|![CodeLens &#45;“从更远分支进行更改”图标](../ide/media/codelensbranchfurtherawayicon.png "CodeLensBranchFurtherAwayIcon")|比父、子或对等更进一步的分支|  
...
### 查找链接代码评审  
 ![CodeLens &#45; 查看代码审阅请求](../ide/media/codelenscodereviews.png "CodeLensCodeReviews")  
...
3.  如果看到警告图标 ![CodeLens &#45;“单元测试尚未运行”警告](../ide/media/codelenstestwarningicon.png "CodeLensTestWarningIcon")，请运行测试。  
...
6.  查看更改该测试的人数、更改人员或更改的数目，请参阅[查找代码历史记录和链接项](#FindCodeHistory)。  
...
-   如果你的代码存储在 TFS 中，请确保使用 [CodeIndex 命令](../ide/codeindex-command.md)和 [TFS Config 命令](http://msdn.microsoft.com/zh-cn/94424190-3b6b-4f33-a6b6-5807f4225b62)打开代码索引。  
  
-   仅当工作项已链接到代码并且你有权打开链接的工作项时，才显示与 TFS 相关的指示器。[确认你具有团队成员权限。](http://msdn.microsoft.com/zh-cn/f58805de-ba61-4d09-8f2d-d3ab9662ecfd)  
 ...
 **答：**可以，请选择 ![CodeLens &#45; 停靠为窗口](../ide/media/codelensdockwindow.png "CodeLensDockWindow") 作为窗口停靠 CodeLens。  
...
-   **测试**：[查找代码的单元测试](#FindRunUnitTests)以刷新此标记。  
 ...
 **答：**可以，如果代码位于 TFS 中，请使用 [CodeIndex 命令](../ide/codeindex-command.md)和 [TFS Config 命令](http://msdn.microsoft.com/zh-cn/94424190-3b6b-4f33-a6b6-5807f4225b62)。