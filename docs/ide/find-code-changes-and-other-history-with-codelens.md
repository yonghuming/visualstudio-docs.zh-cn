...
-   Visual C# .NET 或 Visual Basic .NET 代码  
 ...
 ![CodeLens - 查看引用](~/docs/ide/media/codelensviewreferencespeekreference.png "CodeLensViewReferencesPeekReference")  
...
-   [Lync 2010 或更高版本、或 Skype for Business](http://technet.microsoft.com/en-us/lync)，可从代码编辑器联系你的团队  
 ...
 ![代码元素 - 级别指示器](~/docs/ide/media/codelenselementlevelindicators.png "CodeLensElementLevelIndicators")  
  
 对于可在 Visual Studio 编辑器中打开的所有其他类型的文件，在窗口底部的某个位置获取整个文件的 CodeLens 详细信息（*文件级* 指示器）。  
  
 ![文件 - 级别 CodeLens 指示器](~/docs/ide/media/almcodelensfilelevelindicators.png "ALMCodeLensFileLevelIndicators")  
  
 若要使用键盘来选择指示器，请按住“ALT”  键以显示相关的数字键。  
  
 ![按 Alt 以查看键盘访问数字键](~/docs/ide/media/codelensaltkeyindicators.png "CodeLensAltKeyIndicators")  
...
### <a name="find-changes-in-your-code"></a>查找你的代码中的更改  
 ...
 ![CodeLens：获取 TFVC 中代码的更改历史记录](~/docs/ide/media/codelenscodechanges.png "CodeLensCodeChanges")  
 ...
 ![显示所有代码更改](~/docs/ide/media/codelensshowsallchanges.png "CodeLensShowsAllChanges")  
  
 这将打开变更集的历史记录窗口。  
  
 ![所有代码更改的历史记录窗口](~/docs/ide/media/codelenscodechangeshistory.png "CodeLensCodeChangesHistory")  
  
 当你的文件位于 Git 存储库中并且你选择代码元素级更改指示器时，这将是你所看到的内容。  
  
 ![CodeLens：获取 Git 中代码的更改历史记录](~/docs/ide/media/codelenscodechangesgit.png "CodeLensCodeChangesGit")  
 ...
 ![CodeLens：通过图形查看代码更改历史记录](~/docs/ide/media/codelens.png "CodeLens")  
...
#### <a name="find-incoming-changes-from-other-branches"></a>查找来自其他分支的传入更改  
 ![CodeLens：查找其他分支中的代码更改](~/docs/ide/media/codelensbranchchangecheckinconceptual.png "CodeLensBranchChangeCheckinConceptual")  
...
|**图标**|**更改来源于何处？**|  
|--------------|-----------------------------------------|  
|![CodeLens：“从当前分支进行更改”图标](~/docs/ide/media/codelensbranchcurrenticon.png "CodeLensBranchCurrentIcon")|当前的分支|  
|![CodeLens -“从父分支进行更改”图标](~/docs/ide/media/codelensbranchparenticon.png "CodeLensBranchParentIcon")|父分支|  
|![CodeLens：“从子分支进行更改”图标](~/docs/ide/media/codelensbranchchildicon.png "CodeLensBranchChildIcon")|子分支|  
|![CodeLens -“从对等分支进行更改”图标](~/docs/ide/media/codelensbranchpeericon.png "CodeLensBranchPeerIcon")|对等分支|  
|![CodeLens -“从更进一步的分支进行更改”图标](~/docs/ide/media/codelensbranchfurtherawayicon.png "CodeLensBranchFurtherAwayIcon")|比父、子或对等更进一步的分支|  
|![CodeLens：“从父分支进行合并”图标](~/docs/ide/media/codelensbranchmergefromparenticon.png "CodeLensBranchMergeFromParentIcon")|从父分支到子分支的合并|  
|![CodeLens：“从子分支进行合并”图标](~/docs/ide/media/codelensbranchmergefromchildicon.png "CodeLensBranchMergeFromChildIcon")|从子分支到父分支的合并|  
|![CodeLens：“从不相关的分支进行合并”图标](~/docs/ide/media/codelensbranchmergefromunrelatedicon.png "CodeLensBranchMergeFromUnrelatedIcon")|来自不相关分支的合并（baseless 合并）|  
...
### <a name="contact-the-owner-of-an-item"></a>联系项的所有者  
 ![联系项的所有者](~/docs/ide/media/codelenscontactitemowner.png "CodeLensContactItemOwner")  
  
 打开一个项的快捷菜单来查看联系人选项。 如果安装了 Lync 或 Skype for Business，则会看到以下选项：  
  
 ![项的联系人选项](~/docs/ide/media/codelensitemcontactmenu.png "CodeLensItemContactMenu")  
...
3.  如果看到警告图标 ![CodeLens - 单元测试尚未运行警告](~/docs/ide/media/codelenstestwarningicon.png "CodeLensTestWarningIcon")，请运行测试。  
...
5.  查看测试结果。 选择测试状态指示器（![CodeLens -“单元测试未通过”图标](~/docs/ide/media/codelenstestfailedicon.png "CodeLensTestFailedIcon")或 ![CodeLens -“单元测试已通过”图标](~/docs/ide/media/codelenstestpassedicon.png "CodeLensTestPassedIcon")），或按 **Alt+1**。  
 ...
 **答：**  可以关闭或打开指示器，引用指示器除外。 请依次转到“工具”、“选项”、“文本编辑器”、“所有语言”和“CodeLens”。  
 ...
 ![打开和关闭文件级别指示器](~/docs/ide/media/codelensfilelevelonandoff.png "CodeLensFileLevelOnAndOff")  
 ...
 **答：**是的，选择 ![CodeLens - 停靠为窗口](~/docs/ide/media/codelensdockwindow.png "CodeLensDockWindow")，将 CodeLens 停靠为窗口。  
  
 ![停靠 CodeLens 指示器窗口](~/docs/ide/media/codelensselectdockwindow.png "CodeLensSelectDockWindow")  
  
 ![停靠的 CodeLens 引用窗口](~/docs/ide/media/codelensreferencesdockedwindow.png "CodeLensReferencesDockedWindow")  
