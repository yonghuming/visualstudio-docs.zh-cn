...
---
# 如何：创建类型之间的关联（类设计器）
<a id="how-to-create-associations-between-types-class-designer" class="xliff"></a>
...
### 在类关系图中定义关联连线
<a id="to-define-an-association-line-in-the-class-diagram" class="xliff"></a>  
...
### 更改关联的名称
<a id="to-change-the-name-of-an-association" class="xliff"></a>  
