---
title: "在 Visual Studio 中，使用 XAML 设计器创建 UI | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
Visual Studio 中的 XAML 设计器提供可视化界面，有助于设计基于 XAML 的 Windows 应用商店、Windows Phone、WPF 和 Silverlight 应用程序。 可以通过拖动“工具箱”中的控件，并在“属性”窗口设置属性，为应用程序创建用户界面。 还可以直接在 XAML 视图中编辑 XAML。  
 ...
 有关高级 XAML 设计任务（例如动画和行为）的详细信息，请参阅[使用 Blend for Visual Studio 创建 UI](../designers/creating-a-ui-by-using-blend-for-visual-studio.md)。  
...
## 创作视图  
 ...
 在“设计”视图，包括*“美工板”*的窗口是活动窗口，并且可以将其用作主要工作台面。 可通过添加或绘制元素，然后对其进行修改，在应用程序中用于直观地设计页面。 有关更多信息，请参见[在 XAML 设计器中使用元素](../designers/working-with-elements-in-xaml-designer.md)。 此图显示了“设计”视图中的美工板。  
  
 ![XAML 设计器的设计视图](../designers/media/xaml_editor_design_view.png "xaml\_editor\_design\_view")  
 ...
 **重设句柄大小**  
 重设句柄大小显示在所选控件上，使你能够调整控件的大小。 当调整控件大小时，通常会出现宽度和高度值，帮助设置控件的大小。 有关在“设计”视图中操纵控件的详细信息，请参见[在 XAML 设计器中使用元素](../designers/working-with-elements-in-xaml-designer.md)。  
 ...
 **元素句柄**  
 ...
 ![设计视图命令](../designers/media/xaml_editor_design_controls.png "xaml\_editor\_design\_controls")  
 ...
 **开启\/关闭对齐线对齐**  
 ...
 ![XAML 视图](../designers/media/xaml_editor.png "xaml\_editor")  
...
## 设备窗口  
 ...
 ![“设备”窗口](../designers/media/xaml_editor_device_panel.png "xaml\_editor\_device\_panel")  
...
-   选择元素，以便可以对其进行修改（在层次结构中移动它们、在美工板上对其进行修改以及在“属性”窗口中设置其属性等）。 有关详细信息，请参见[在 XAML 设计器中使用元素](../designers/working-with-elements-in-xaml-designer.md)  
...
-   对所选元素使用上下文菜单。 同一个菜单对美工板中的所选元素也可用。  
 ...
 ![“文档大纲”窗口](../designers/media/xaml_editor_doc_outline.png "xaml\_editor\_doc\_outline")  
...
## “属性”窗口  
 ...
 ![“属性”窗口](../designers/media/xaml_editor_prop_window.png "xaml\_editor\_prop\_window")  
