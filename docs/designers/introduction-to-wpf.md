...
使用 Windows Presentation Foundation (WPF)，你可以创建适用于 Windows 且具有非凡视觉效果的桌面客户端应用程序。  
 ...
 ![Contoso Healthcare UI 示例](~/docs/designers/media/wpfintrofigure24.png "WPFIntroFigure24")  
...
```  
 ...
 ![包含按钮的窗口](~/docs/designers/media/wpfintrofigure10.png "WPFIntroFigure10")  
...
```  
 ...
 ![消息框](~/docs/designers/media/wpfintrofigure25.png "WPFIntroFigure25")  
...
>  由父控件实现以便子控件使用的属性是 WPF 构造，称为 [附加属性](https://msdn.microsoft.com/en-us/library/ms749011\(v=vs.100\).aspx)。  
 ...
 ![DockPanel 页](~/docs/designers/media/wpfintrofigure11.png "WPFIntroFigure11")  
...
### <a name="2-d-shapes"></a>二维形状  
 ...
 ![椭圆和矩形](~/docs/designers/media/wpfintrofigure4.PNG "WPFIntroFigure4")  
 ...
 ![包含文本“你已单击省略号!”的窗口](~/docs/designers/media/wpfintrofigure12.png "WPFIntroFigure12")  
...
### <a name="2-d-geometries"></a>二维几何图形  
 ...
 ![Path 的各种用法](~/docs/designers/media/wpfintrofigure5.PNG "WPFIntroFigure5")  
...
### <a name="2-d-effects"></a>二维效果  
 ...
 ![不同画笔的图示](~/docs/designers/media/wpfintrofigure6.PNG "WPFIntroFigure6")  
...
### <a name="3-d-rendering"></a>三维呈现  
 ...
 ![Visual3D 示例屏幕快照](~/docs/designers/media/wpfintrofigure13.png "WPFIntroFigure13")  
...
##  <a name="Animation"></a> 动画  
 ...
 ![具有动画多维数据集的图像](~/docs/designers/media/wpfintrofigure7.png "WPFIntroFigure7")  
...
### <a name="images"></a>图像  
 ...
 ![缩略图图像和完整尺寸图像](~/docs/designers/media/wpfintrofigure8.PNG "WPFIntroFigure8")  
...
### <a name="video-and-audio"></a>视频和音频  
 ...
 ![具有音频和视频的 MediaElement 控件](~/docs/designers/media/wpfintrofigure1.png "WPFIntroFigure1")  
...
-   国际字体支持和回退机制。  
 ...
 ![具有各种文本修饰的文本](~/docs/designers/media/wpfintrofigure23.png "WPFIntroFigure23")  
...
[!code-xml[IntroToWPFSnippets#TextBoxContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_12.xaml)]  
 ...
 ![包含文本的 TextBox 控件](~/docs/designers/media/wpfintrofigure21.png "WPFIntroFigure21")  
...
[!code-xml[IntroToWPFSnippets#ButtonContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_15.xaml)]  
 ...
 ![包含多种类型的内容的按钮](~/docs/designers/media/wpfintrofigure22.png "WPFIntroFigure22")  
...
### <a name="control-templates"></a>控件模板  
 ...
 ![省略号按钮和第二个窗口](~/docs/designers/media/wpfintrofigure2.png "WPFIntroFigure2")  
...
### <a name="data-templates"></a>数据模板  
 ...
 ![具有默认外观的列表框](~/docs/designers/media/wpfintrofigure18.png "WPFIntroFigure18")  
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_21.xaml)]  
 ...
 ![使用数据模板的列表框](~/docs/designers/media/wpfintrofigure19.png "WPFIntroFigure19")  
...
[!code-xml[IntroToWPFSnippets#StyleMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_25.xaml)]  
 ...
 ![两个橙色按钮](~/docs/designers/media/wpfintrofigure20.png "WPFIntroFigure20")  
...
-   **框架元素模型**。 当其外观由自定义呈现逻辑（而不是模板）定义时，自定义控件派生自 <xref:System.Windows.FrameworkElement> 。  
 ...
 ![自定义用户控件](~/docs/designers/media/wpfintrofigure3.png "WPFIntroFigure3")  
