---
title: "在开发过程中验证您的系统 |Microsoft 文档"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Visual Studio 可帮助使你的软件与用户的要求和系统的体系结构保持一致。  
 ...
 若要查看哪些版本的 Visual Studio 支持上述每个功能，请参阅[体系结构和建模工具的版本支持](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport)。  
...
|**任务**|**相关的主题**|  
|---------------|---------------------------|  
|**请确保软件满足用户要求**：<br /><br /> 可以使用要求模型和体系结构模型来帮助组织系统及其组件的测试。 这种做法有助于确保你测试了对于用户和其他利益干系人而言非常重要的要求，并可帮助你在要求发生变化时快速更新测试。|-   [开发测试从模型](../modeling/develop-tests-from-a-model.md)|  
|**请确保您的软件将保持与您的系统的预期设计保持一致︰**<br /><br /> 依赖项关系图描述了您的应用程序的组件之间的预期依赖关系。 在开发期间，你可以验证代码中的实际依赖关系是否符合预期设计。|-   [在代码中创建依赖项关系图](../modeling/create-layer-diagrams-from-your-code.md)<br />-   [使用依赖项关系图验证代码](../modeling/validate-code-with-layer-diagrams.md)|  
