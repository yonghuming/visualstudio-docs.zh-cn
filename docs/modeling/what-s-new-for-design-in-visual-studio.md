...
![在操作中的实时依赖项验证](~/modeling/media/dep-validation-whatsnew-01.png)

创作体验已更改，以使依赖项验证更容易地发现、 更易于访问，更改到"依赖项关系图"从"层关系图"术语。

**体系结构**菜单现在包含直接创建一个依赖项关系图的命令︰

![体系结构菜单中的实时依赖项](~/modeling/media/dep-validation-whatsnew-02.png)

...和依赖项关系图中和它们的说明中的层的属性名称已更改，以使它们更有意义︰

![实时更新的依赖项属性名称](~/modeling/media/dep-validation-whatsnew-03.png)
