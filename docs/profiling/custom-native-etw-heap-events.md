...
![Windows 堆分配](~/docs/profiling/media/heap-example-windows-heap.png)
...
![启用堆分析](~/docs/profiling/media/heap-enable-heap.png)

若要查看自定义堆跟踪，请使用位于“快照”窗口右上角的“堆”下拉菜单，将视图从“NT 堆” 更改为之前已命名的自己的堆。

![堆选择](~/docs/profiling/media/heap-example-custom-heap.png)
...
![带跟踪器的 NT 堆](~/docs/profiling/media/heap-example-windows-heap.png)
