...
## <a name="lock-contention-and-serialized-execution"></a>锁争用和序列化执行  
 ![锁争用导致序列化执行](~/docs/profiling/media/lockcontention_serialized.png "LockContention_Serialized")  
 ...
 ![锁争用](~/docs/profiling/media/lockcontention_2.png "LockContention_2")  
  
## <a name="uneven-workload-distribution"></a>不均匀的工作负载分布  
 ![不均匀的工作负载](~/docs/profiling/media/unevenworkload_1.png "UnevenWorkLoad_1")  
 ...
 ![不均匀的工作负荷](~/docs/profiling/media/unevenworkload_2.png "UnevenWorkload_2")  
  
## <a name="oversubscription"></a>过度订阅  
 ![过度订阅](~/docs/profiling/media/oversubscription.png "Oversubscription")  
...
## <a name="inefficient-io"></a>I/O 效率低  
 ![I/O 效率低](~/docs/profiling/media/inefficient_io.png "Inefficient_IO")  
...
## <a name="lock-convoys"></a>锁保护  
 ![锁保护](~/docs/profiling/media/lock_convoys.png "Lock_Convoys")  
