...
![诊断工具窗口](~/docs/profiling/media/prof-tour-diagnostic-tools.png "诊断工具")

调试时，你可以使用“诊断工具”窗口分析 CPU 和内存使用情况，并且可以查看显示性能相关信息的事件。

![诊断工具摘要视图](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Diagnostic Tools Summary")
...
![启用诊断工具中的 CPU 使用情况](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Diagnostic Tools Enable CPU Usage")
...
![诊断工具 CPU 使用情况视图](~/docs/profiling/media/prof-tour-cpu-usage.png "Diagnostic Tools CPU Usage")
...
![诊断工具调用方被调用方“蝶形”视图](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Diagnostics Tools Caller Callee View")
...
![在诊断工具中拍摄快照](~/docs/profiling/media/prof-tour-take-snapshots.gif "Diagnostic Tools Take Snapshots")

选择其中一个箭头链接时，系统会提供关于堆的差异视图（一个向上的红色箭头![内存使用量增加](~/docs/profiling/media/prof-tour-mem-usage-up-arrow.png "Memory Usage Increase")表明对象计数（左）增加或堆大小（右）增加）。 如果单击右侧的链接，将获得按堆大小增加最多的对象进行排序的差异堆视图。 这可帮助查明内存问题。 例如，在下图中，`ClassHandlersStore` 对象使用的字节数在第二张快照中增加了 3,492 字节。

![诊断工具堆差异视图](~/docs/profiling/media/prof-tour-mem-usage-diff-heap.png "Diagnostics Tools Heap Diff view")
...
![诊断工具事件视图](~/docs/profiling/media/prof-tour-events.png "Diagnostic Tools View Events")
...
![分析教程性能提示](~/docs/profiling/media/prof-tour-perf-tips.png "Profiling Tour PerfTips")
...
![在诊断工具中查看 UI 分析事件](~/docs/profiling/media/prof-tour-ui-analysis.png "Diagnostic Tools View UI Analysis Events")
...
![性能探查器](~/docs/profiling/media/prof-tour-performance-profiler.png "Performance Profiler")
...
![应用程序时间线分析工具](~/docs/profiling/media/prof-tour-application-timeline.gif "Profiling Tour Application Timeline")
...
![GPU 使用情况分析工具](~/docs/profiling/media/prof-tour-gpu-usage.png "Diag GPU Usage")
...
![网络使用情况分析工具](~/docs/profiling/media/prof-tour-network-usage.png "Diag Network Usage")

选择摘要视图中的操作以查看更多详细信息。

![网络使用情况工具中的详细信息](~/docs/profiling/media/prof-tour-network-usage-details.png "Diag Network Usage Details")
...
![性能资源管理器工具](~/docs/profiling/media/prof-tour-performance-explorer.png "Performance Explorer")
