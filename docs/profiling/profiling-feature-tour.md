...
![诊断工具](../profiling/media/prof-tour-diagnostic-tools.png "Diagnostics Tools")

调试时，你可以使用“诊断工具”窗口分析 CPU 和内存使用情况，并且可以查看显示性能相关信息的事件。

![诊断工具摘要](../profiling/media/prof-tour-cpu-and-memory-graph.gif "Diagnostics Tools Summary")
...
![诊断工具启用 CPU 使用率](../profiling/media/prof-tour-enable-cpu-profiling.png "Diagnostics Tools Enable CPU Usage")
...
![诊断工具 CPU 使用率](../profiling/media/prof-tour-cpu-usage.png "Diagnostics Tools CPU Usage")

双击感兴趣的函数，然后将看到更加详细的三窗格视图，其中所选函数位于窗口中央，调用函数位于左侧，而被调用函数位于右侧。 **函数体**部分显示函数体中所用的时间总量（及百分比），其中不包括调用和被调用函数中所用的时间。 此数据可以帮助评估函数本身是否属于性能瓶颈。

![诊断工具调用方被调用方视图](../profiling/media/prof-tour-cpu-usage-caller-callee.png "Diagnostics Tools Caller Callee View")
...
![诊断工具拍摄快照](../profiling/media/prof-tour-take-snapshots.gif "Diagnostics Tools Take Snapshots")
...
![诊断工具视图事件](../profiling/media/prof-tour-events.png "Diagnostics Tools View Events")

 > [!NOTE]
 > 如果你有 Visual Studio Enterprise，你还可以在此选项卡中查看 [IntelliTrace 事件](../debugger/intellitrace.md)。

相同事件会出现在代码编辑器中，可将其作为性能提示进行查看。
...
![诊断工具视图 UI 分析事件](../profiling/media/prof-tour-ui-analysis.png "Diagnostics Tools View UI Analysis Events")
...
![分析教程应用程序时间线](../profiling/media/prof-tour-application-timeline.gif "Profiling Tour Application Timeline")
...
![Diag GPU 使用情况](../profiling/media/prof-tour-gpu-usage.png "Diag GPU Usage")
...
![诊断网络使用情况](../profiling/media/prof-tour-network-usage.png "Diag Network Usage")

选择摘要视图中的操作以查看更多详细信息。

![诊断网络使用情况详细信息](../profiling/media/prof-tour-network-usage-details.png "Diag Network Usage Details")
...
![性能资源管理器](../profiling/media/prof-tour-performance-explorer.png "Performance Explorer")
