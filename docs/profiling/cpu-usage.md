...
1.  在 Visual Studio 中，将解决方案配置设置为“零售”  ，然后选择部署目标。  
     ...
     ![选择发布和本地计算机](~/docs/profiling/media/cpuuse_selectreleaselocalmachine.png "CPUUSE_SelectReleaseLocalMachine")  
...
3.  选择“CPU 使用率”  ，然后选择“启动” 。  
     ...
     ![选择 CPU 使用率](~/docs/profiling/media/cpuuse_lib_choosecpuusage.png "CPUUSE_LIB_ChooseCpuUsage")  
