...
在此上下文中使用关键字 "base" 无效  
 ...
 必须使用 [base](/dotnet/csharp/language-reference/keywords/base) 关键字指定基类的特定成员。 有关详细信息，请参阅[构造函数](/dotnet/csharp/programming-guide/classes-and-structs/constructors)。  
