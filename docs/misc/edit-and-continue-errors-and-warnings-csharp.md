...
已对 Visual C\#“编译并继续”中不允许的代码段进行了编辑。  
 ...
 有关 [!INCLUDE[csharp_current_short](../misc/includes/csharp_current_short_md.md)] 的“编辑并继续”中支持的编辑的详细信息，请参阅[受支持的代码更改 \(C\#\)](../debugger/supported-code-changes-csharp.md)。 如果需要有关特定错误或警告的详细信息，可以在 MSDN [Visual C\# IDE 论坛](http://go.microsoft.com/fwlink/?LinkId=214693)上搜索或发布。  
