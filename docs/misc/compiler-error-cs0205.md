...
无法调用抽象基成员：“method”  
 ...
 无法调用 [abstract](/dotnet/csharp/language-reference/keywords/abstract) 方法，因为没有方法正文。 有关更多信息，请参见[抽象类、密封类及类成员](/dotnet/csharp/programming-guide/classes-and-structs/abstract-and-sealed-classes-and-class-members)。  
