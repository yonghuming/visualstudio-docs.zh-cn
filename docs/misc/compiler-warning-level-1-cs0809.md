...
过时成员“memberA”重写未过时成员“memberB”。  
 ...
 通常情况下，标记为过时的成员不应重写未标记为过时的成员。 在 [!INCLUDE[vs_orcas_long](../debugger/includes/vs_orcas_long_md.md)] 中将生成此警告，但在 [!INCLUDE[vsprvslong](../code-quality/includes/vsprvslong_md.md)] 中不会生成此警告。  
