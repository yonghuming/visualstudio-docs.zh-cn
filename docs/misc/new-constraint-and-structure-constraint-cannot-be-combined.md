...
约束列表同时包含 [New 运算符](/dotnet/visual-basic/language-reference/operators/new-operator) 约束和 [Structure \(Visual Basic\)](http://msdn.microsoft.com/zh-cn/263ce115-ac36-4c05-8cb7-0e0eead5c6d0) 约束。  
