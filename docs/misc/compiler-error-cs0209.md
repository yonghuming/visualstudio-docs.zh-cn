...
fixed 语句中声明的局部变量类型必须是指针类型  
 ...
 [fixed 语句](/dotnet/csharp/language-reference/keywords/fixed-statement)中声明的变量必须是指针。 有关详细信息，请参阅[不安全代码和指针](/dotnet/csharp/programming-guide/unsafe-code-pointers/index)。  
