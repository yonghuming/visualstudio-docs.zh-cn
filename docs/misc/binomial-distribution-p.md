...
## 备注  
 有关代码示例，请参阅 [binomial\_distribution 类](/visual-cpp/standard-library/binomial-distribution-class)。  
...
## 请参阅  
 ...
 [binomial\_distribution 类](/visual-cpp/standard-library/binomial-distribution-class)   
