...
一元运算符的参数必须是包含类型  
 ...
 运算符重载的方法声明必须遵循特定的准则。 有关更多信息，请参见[可重载运算符](/dotnet/csharp/programming-guide/statements-expressions-operators/overloadable-operators)和[Operator Overloading Sample](http://msdn.microsoft.com/zh-cn/1c6b4610-0a49-4532-8fa7-f694cfc65743)。  
