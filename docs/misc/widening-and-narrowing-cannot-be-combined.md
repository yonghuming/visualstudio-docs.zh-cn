...
[Operator 语句](/dotnet/visual-basic/language-reference/statements/operator-statement) 同时指定 [Widening](/dotnet/visual-basic/language-reference/modifiers/widening) 和 [Narrowing](/dotnet/visual-basic/language-reference/modifiers/narrowing)。  
