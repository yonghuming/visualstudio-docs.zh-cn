...
事件“event”只能出现在 \+\= 或 \-\= 的左边  
 ...
 未正确调用 [event](/dotnet/csharp/language-reference/keywords/event)。 有关详细信息，请参阅 [事件](/dotnet/csharp/programming-guide/events/index) 和 [委托](/dotnet/csharp/programming-guide/delegates/index)。  
