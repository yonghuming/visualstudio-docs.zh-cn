...
条件表达式中的赋值总是常量；是否希望使用 "\=\=" 而非 "\="?  
 ...
 条件表达式使用 [\= 运算符](/dotnet/csharp/language-reference/operators/assignment-operator)而不是 [\=\= 运算符](/dotnet/csharp/language-reference/operators/equality-comparison-operator)。  
