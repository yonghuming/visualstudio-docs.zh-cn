...
类型成员名称与在所有枚举中隐式声明的成员名称相冲突。  
 ...
 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 编译器创建与你声明的某些编程元素相对应的隐式成员。 枚举隐式声明成员 `value__member`。  
...
## 请参阅  
 ...
 [枚举概述](/dotnet/visual-basic/programming-guide/language-features/constants-enums/enumerations-overview)   
