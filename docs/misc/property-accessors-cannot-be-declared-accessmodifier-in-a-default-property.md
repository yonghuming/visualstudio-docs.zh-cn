...
默认属性中的 [Get 语句](/dotnet/visual-basic/language-reference/statements/get-statement) 或 [Set 语句](/dotnet/visual-basic/language-reference/statements/set-statement) 包括 `Private` 关键字。  
...
-   从 `Get` 或 `Set` 语句中删除 `Private` 关键字，或从 [Property 语句](/dotnet/visual-basic/language-reference/statements/property-statement) 中删除 `Default`。  
