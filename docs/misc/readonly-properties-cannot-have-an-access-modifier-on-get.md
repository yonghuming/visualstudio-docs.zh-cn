...
`ReadOnly` 属性声明在 [Property 语句](/dotnet/visual-basic/language-reference/statements/property-statement)和 [Get 语句](/dotnet/visual-basic/language-reference/statements/get-statement) 中都指定了访问级别。  
