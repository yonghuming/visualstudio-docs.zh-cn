...
不安全代码只会在使用 \/unsafe 编译的情况下出现  
 ...
 如果源的代码包含 [unsafe](/dotnet/csharp/language-reference/keywords/unsafe) 关键字，则还必须使用 [\/unsafe](/dotnet/csharp/language-reference/compiler-options/unsafe-compiler-option) 编译器选项。 有关更多信息，请参见[不安全代码和指针](/dotnet/csharp/programming-guide/unsafe-code-pointers/index)。  
