...
---
# “New”不能在接口上使用
将一个变量声明为一个接口类型时，[Dim 语句](/dotnet/visual-basic/language-reference/statements/dim-statement) 使用 [New 运算符](/dotnet/visual-basic/language-reference/operators/new-operator) 子句。  
