...
方法必须具有返回类型  
 ...
 在类、结构或接口中声明的方法必须具有显式返回类型。 在下面的示例中，Square 方法具有[字符串](/dotnet/csharp/language-reference/keywords/string)返回值：  
...
## 请参阅  
 ...
 [构造函数](/dotnet/csharp/programming-guide/classes-and-structs/constructors)