...
## 请参阅  
 [通过值传递参数和通过引用传递参数之间的差异](/dotnet/visual-basic/programming-guide/language-features/procedures/differences-between-passing-an-argument-by-value-and-by-reference)   
