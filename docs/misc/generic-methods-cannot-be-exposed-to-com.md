...
---
# 不能向 COM 公开泛型方法
包含一个或多个泛型过程的 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 组件导出到了 COM 组件。  
...
-   从 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 组件中删除一个或多个泛型过程，或者不在 COM 交互操作中使用泛型过程。  
