...
helpviewer_keywords: 
  - "Vspackage, 安装"
  - "安装 [Visual Studio SDK], Vspackage"
...
---
# 安装 VSPackage
本部分讨论如何生成和安装 Vspackage 以及如何支持同时运行多个版本的 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 的用户。  
...
## 相关章节  
 ...
 描述可以如何扩展 [!INCLUDE[vsprvstte](../misc/includes/vsprvstte_md.md)] 以支持新类型的测试。  
  
 [Visual Studio 集成测试](http://msdn.microsoft.com/zh-cn/8d741735-7d93-46c2-ab93-01da7a0e016d)  
 提供了一组测试，以帮助确保 Vspackage 正确地集成到 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 中。  
  
 [发布产品](../misc/releasing-a-visual-studio-integration-product.md)  
 演示如何发布 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 集成产品。