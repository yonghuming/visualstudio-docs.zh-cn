...
“class”没有合适的静态 Main 方法  
 ...
 [\/main](/dotnet/csharp/language-reference/compiler-options/main-compiler-option) 编译器选项指定了一个在其中查找 **Main** 方法的类。 但是，[Main](/dotnet/csharp/programming-guide/main-and-command-args/main-and-command-line-arguments) 方法未正确定义。  
