...
params 参数必须是形参表中的最后一个参数。  
 ...
 [Params](/dotnet/csharp/language-reference/keywords/params) 参数支持可变数目的实参，并且必须位于所有其他形参之后。 有关详细信息，请参阅[方法](/dotnet/csharp/programming-guide/classes-and-structs/methods)。  
