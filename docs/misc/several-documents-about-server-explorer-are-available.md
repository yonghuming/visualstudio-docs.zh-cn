...
[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 帮助包含有关**“服务器资源管理器”**的文档，此文档可能应用于您的帮助请求。选择最适合您尝试完成的任务的文档。  
  
|标题|说明|  
|--------|--------|  
|[“添加服务器”对话框](../Topic/Add%20Server%20Dialog%20Box.md)|描述**“添加服务器”**对话框，该对话框可用于指定要在**“服务器资源管理器”**中显示的服务器。|  
|[有关数据访问错误疑难解答的其他资源](../data-tools/additional-resources-for-troubleshooting-data-access-errors.md)|链接到有关数据服务的文档。|  
...
|[服务器资源管理器](../Topic/Server%20Explorer.md)|描述**“服务器资源管理器”**\/**“数据库资源管理器”**，这是 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 的服务器管理控制台。|  
|[使用服务器资源管理器浏览 SharePoint 连接](/office-dev/office-dev/browsing-sharepoint-connections-using-server-explorer)|描述如何使用**“服务器资源管理器”**浏览 SharePoint 网站。|  
|[本地数据概述](../data-tools/local-data-overview.md)|描述如何将数据库文件 \(.mdf\) 转换为 [!INCLUDE[vs_dev11_long](../data-tools/includes/vs_dev11_long_md.md)]使用的格式。|