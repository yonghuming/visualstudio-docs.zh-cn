...
`WriteOnly` 属性声明在 [Property 语句](/dotnet/visual-basic/language-reference/statements/property-statement)和 [Set 语句](/dotnet/visual-basic/language-reference/statements/set-statement) 中都指定了访问级别。  
