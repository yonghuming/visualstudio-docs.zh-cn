...
在控件离开当前方法之前，必须对 out 参数“parameter”赋值  
 ...
 未向标记有 [out](/dotnet/csharp/language-reference/keywords/out) 关键字的参数分配方法主体中的值。 有关详细信息，请参阅[传递参数](/dotnet/csharp/programming-guide/classes-and-structs/passing-parameters)。  
