...
已针对不属于类型 <xref:System.Xml.Linq.XElement> or `IEnumerable(Of XElement)` 的对象引用了一个 XML 特性。 有关更多信息，请参见[XML 特性轴属性](/dotnet/visual-basic/language-reference/xml-axis/xml-attribute-axis-property)。  
...
## 请参阅  
 [XML 特性轴属性](/dotnet/visual-basic/language-reference/xml-axis/xml-attribute-axis-property)   
