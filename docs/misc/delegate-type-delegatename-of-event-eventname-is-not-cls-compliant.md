...
[Event 语句](/dotnet/visual-basic/language-reference/statements/event-statement)使用委托来指定其签名，但 [Delegate 语句](/dotnet/visual-basic/language-reference/statements/delegate-statement)被标记为 `<CLSCompliant(False)>` 或未标记。  
