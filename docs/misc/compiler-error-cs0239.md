...
“member”：继承成员“inherited member”是密封的，无法进行重写  
 ...
 成员不能[重写](/dotnet/csharp/language-reference/keywords/override)一个[密封的](/dotnet/csharp/language-reference/keywords/sealed)继承成员。 有关更多信息，请参见[Checked 和 Unchecked](/dotnet/csharp/language-reference/keywords/checked-and-unchecked)。  
