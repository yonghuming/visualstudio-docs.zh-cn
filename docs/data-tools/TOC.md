...
# 教程
## [使用 ADO.NET 创建简单的数据应用](create-a-simple-data-application-by-using-adonet.md)
## [通过使用 WPF 和实体框架创建简单的数据应用](create-a-simple-data-application-with-wpf-and-entity-framework-6.md)
## [从 C++ 应用连接到数据](visual-studio-data-tools-for-cpp.md)
## [使用 O/R 设计器创建 LINQ to SQL 类](walkthrough-creating-linq-to-sql-classes-by-using-single-table-inheritance-o-r-designer.md)
## [创建 N 层数据应用程序](walkthrough-creating-an-n-tier-data-application.md)
# 概念
## [兼容的数据库系统](installing-database-systems-tools-and-samples.md)
## [适用于 NET 的 Visual Studio Data Tools](visual-studio-data-tools-for-dotnet.md)
## [实体框架工具](entity-data-model-tools-in-visual-studio.md)
## [数据集工具](dataset-tools-in-visual-studio.md)
### [类型化与非类型化数据集](typed-vs-untyped-datasets.md)
### [Tableadapter 概述](fill-datasets-by-using-tableadapters.md)
### [在 N 层应用程序中使用数据集](work-with-datasets-in-n-tier-applications.md)
## [数据库项目和数据层应用程序 (DAC)](creating-and-managing-databases-and-data-tier-applications-in-visual-studio.md)
## [N 层数据应用程序概述](n-tier-data-applications-overview.md)
# 操作指南
## [创建数据库](create-a-sql-database-by-using-a-designer.md)
## [添加连接](add-new-connections.md)
### [保存和编辑连接字符串](how-to-save-and-edit-connection-strings.md)
### [连接到 Access 数据库中的数据](connect-to-data-in-an-access-database-windows-forms.md)
## [添加 .NET 数据源](add-new-data-sources.md)
## [使用 LINQ to SQL 工具](linq-to-sql-tools-in-visual-studio2.md)
### [更改 DataColumn 方法的返回类型](how-to-change-the-return-type-of-a-datacontext-method-o-r-designer.md)
### [创建映射到存储过程的 DataContext 方法](how-to-create-datacontext-methods-mapped-to-stored-procedures-and-functions-o-r-designer.md)
### [使用 O/R 设计器配置继承](how-to-configure-inheritance-by-using-the-o-r-designer.md)
### [创建映射到表和视图的 LINQ to SQL 类](how-to-create-linq-to-sql-classes-mapped-to-tables-and-views-o-r-designer.md)
### [扩展 O/R 设计器生成的代码](how-to-extend-code-generated-by-the-o-r-designer.md)
### [创建 LINQ to SQL 类之间的关联](how-to-create-an-association-relationship-between-linq-to-sql-classes-o-r-designer.md)
### [在实体类中添加验证](how-to-add-validation-to-entity-classes.md)
### [自定义实体类的插入、更新和删除行为](walkthrough-customizing-the-insert-update-and-delete-behavior-of-entity-classes.md)
### [分配存储过程以便执行更新、插入和删除操作](how-to-assign-stored-procedures-to-perform-updates-inserts-and-deletes-o-r-designer.md)
### [启用和禁用复数形式](how-to-turn-pluralization-on-and-off-o-r-designer.md)
## 使用数据集工具
### [在 Visual Studio 中创建和配置数据集](create-and-configure-datasets-in-visual-studio.md)
#### [创建数据集之间的关系](relationships-in-datasets.md)
#### [通过使用数据集设计器创建数据集](walkthrough-creating-a-dataset-with-the-dataset-designer.md)
#### [通过使用数据集设计器创建数据表](walkthrough-creating-a-datatable-in-the-dataset-designer.md)
### TableAdapter
...
## [将控件绑定到数据源](bind-controls-to-data-in-visual-studio.md)
...
### [将 WPF 控件绑定到数据](bind-wpf-controls-to-data-in-visual-studio.md)
#### [将 WPF 控件绑定到数据集](bind-wpf-controls-to-a-dataset.md)
#### [将 WPF 控件绑定到 WCF 数据服务](bind-wpf-controls-to-a-wcf-data-service.md)
#### [创建查找表](create-lookup-tables-in-wpf-applications.md)
#### [显示相关数据](display-related-data-in-wpf-applications.md)
#### [将控件绑定到数据库中的图片](bind-controls-to-pictures-from-a-database.md)
### [将 Windows 窗体控件绑定到数据](bind-windows-forms-controls-to-data-in-visual-studio.md)
...
#### [创建查找表](create-lookup-tables-in-windows-forms-applications.md)
#### [创建用于搜索数据的 Windows 窗体](create-a-windows-form-to-search-data.md)
#### [创建可支持简单数据绑定的用户控件](create-a-windows-forms-user-control-that-supports-simple-data-binding.md)
#### [创建可支持复杂数据绑定的用户控件](create-a-windows-forms-user-control-that-supports-complex-data-binding.md)
#### [创建可支持查找数据绑定的用户控件](create-a-windows-forms-user-control-that-supports-lookup-data-binding.md)
#### [在窗体间传递数据](pass-data-between-forms.md)
### [绑定自定义对象](bind-objects-in-visual-studio.md)
### [自定义 Visual Studio 创建数据绑定控件的标题的方式](customize-how-visual-studio-creates-captions-for-data-bound-controls.md)
## [Windows Communication Foundation 服务和 WCF 数据服务](windows-communication-foundation-services-and-wcf-data-services-in-visual-studio.md)
### [使用概念模型](working-with-a-conceptual-model-wcf-data-services.md)
### [连接到服务中的数据](how-to-connect-to-data-in-a-service.md)
### [在 Windows 窗体中创建 WCF 服务](walkthrough-creating-a-simple-wcf-service-in-windows-forms.md)
### [通过 WPF 和实体框架创建 WCF 数据服务](walkthrough-creating-a-wcf-data-service-with-wpf-and-entity-framework.md)
### [服务引用疑难解答](troubleshooting-service-references.md)
### [“配置服务引用”对话框](configure-service-reference-dialog-box.md)
### [添加、更新或删除 WCF 数据服务引用](how-to-add-update-or-remove-a-wcf-data-service-reference.md)
## [升级 .mdf 文件](upgrade-dot-mdf-files.md)
## [数据访问错误疑难解答](additional-resources-for-troubleshooting-data-access-errors.md)
# 参考
## O/R 设计器 (Linq to SQL)
### [DataContext 方法](datacontext-methods-o-r-designer.md)
### [数据类继承](data-class-inheritance-o-r-designer.md)
