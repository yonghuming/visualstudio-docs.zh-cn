...
大多数符号在图像文件中定义的位置。  符号的位置指定与 [LocationType 枚举](../../debugger/debug-interface-access/locationtype.md) 枚举的值。  符号可能基于其位置支持其他属性。  
