---
title: "Object.defineProperty 函数 (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
-   修改现有属性的特性。  当对象已具有指定的属性名称时，发成此操作。  
 ...
 若要向对象添加多个属性或修改多个现有属性，可使用 [Object.defineProperties 函数](../../javascript/reference/object-defineproperties-function-javascript.md)。  
...
-   此对象不[可扩展](../../javascript/reference/object-isextensible-function-javascript.md)且指定的属性名称不存在。  
