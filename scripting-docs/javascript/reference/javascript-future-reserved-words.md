---
title: "JavaScript 未来保留字 | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# JavaScript 未来保留字
在 JavaScript 中，未来保留关键字不得用作标识符，即使它们在当前版本中没有特殊含义。  
  
 有关 JavaScript 中的保留字的列表，请参见 [JavaScript 保留字](../../javascript/reference/javascript-reserved-words.md)。  
...
## 严格模式下的未来保留字  
 以下是仅适用于严格模式的未来保留字。  有关严格模式的更多信息，请参见 [使用严格指令](../../javascript/reference/use-strict-directive.md)。  
