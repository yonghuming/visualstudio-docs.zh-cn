---
title: "String 对象 (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
## 字符串  
 *字符串文本*是以单引号或双引号括起零个或多个字符。  字符串文本具有 `string` 的主（基元）数据类型。  *String 对象*通过使用 [new 运算符](../../javascript/reference/new-operator-decrementjavascript.md)创建，其数据类型为 `Object`。  
...
## 访问单个字符  
 可以将字符串的单个字符作为只读数组索引属性进行访问。  [!INCLUDE[jsv9text](../../javascript/includes/jsv9text-md.md)] 中已引入此功能。  以下示例访问单个字符串字符。  
...
## 要求  
 已在 [!INCLUDE[jsv1text](../../javascript/reference/includes/jsv1text-md.md)] 中引入 `String Object`。  更高版本中已引入以下列表中的某些成员。  
...
|[big 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<BIG\> 标记放置在文本两侧。|  
|[blink 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<BLINK\> 标记放置在文本两侧。|  
|[bold 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<B\> 标记放置在文本两侧。|  
...
|[fixed 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<TT\> 标记放置在文本两侧。|  
|[fontcolor 方法](../../javascript/reference/html-tag-methods-javascript.md)|将具有 COLOR 特性的 HTML \<FONT\> 标记放置在文本两侧。|  
|[fontsize 方法](../../javascript/reference/html-tag-methods-javascript.md)|将具有 SIZE 特性的 HTML \<FONT\> 标记放置在文本两侧。|  
...
|[italics 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<I\> 标记放置在文本两侧。|  
...
|[match 方法](../../javascript/reference/match-method-string-javascript.md)|通过使用提供的**正则表达式**对象来搜索字符串并以数组形式返回结果。|  
...
|[small 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<SMALL\> 标记放置在文本两侧。|  
...
|[strike 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<STRIKE\> 标记放置在文本两侧。|  
|[sub 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<SUB\> 标记放置在文本两侧。|  
...
|[sup 方法](../../javascript/reference/html-tag-methods-javascript.md)|将 HTML \<SUP\> 标记放置在文本两侧。|  
