---
title: "JSON.stringify 函数 (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
|例外|条件|  
|--------|--------|  
|[替换器参数无效](../../javascript/misc/invalid-replacer-argument.md)|`replacer` 参数不是函数或数组。|  
|[值参数中不支持循环引用](../../javascript/misc/circular-reference-in-value-argument-not-supported.md)|`value` 参数包含循环引用。|  
...
## 请参阅  
 ...
 [订阅源阅读器示例应用（Windows 应用商店）](http://code.msdn.microsoft.com/Feed-reader-sample-99d68cf8)