---
title: "Float32Array 对象 | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
|常量|描述|  
|--------|--------|  
|[BYTES\_PER\_ELEMENT 常量](../../javascript/reference/bytes-per-element-constant-float32array.md)|数组中每个元素的大小（以字节为单位）。|  
