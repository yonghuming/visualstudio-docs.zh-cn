---
title: "项目和解决方案"
description: "本文档概述了 Xamarin Studio 中的项目和解决方案。"
author: asb3993
ms.author: amburns
ms.date: 04/14/2017
ms.topic: article
...
若要创建新的项目或解决方案，请参阅[创建新的项目和解决方案](~/create-new-projects.md)主题。

## <a name="project-and-solution-options"></a>“项目和解决方案”选项

通过双击项目/解决方案名称或右键单击并浏览到“选项”可以同时管理项目和解决方案的属性。 有关这些选项的详细信息，请参阅[管理解决方案和项目属性](~/managing-solutions-and-project-properties.md)主题。
